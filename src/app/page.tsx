    ...
    <div>
      <div className="relative w-full h-screen overflow-hidden mb-20">
        <div className="absolute inset-0 flex flex-col items-center justify-between h-full">
          ...
          {/* Content Section */}
          <div className="animate-fade-in-down flex flex-col gap-8 items-center justify-center flex-grow">
            {/* Mobile Icon - Only on smaller screens */}
            ...
            {/* Main Title */}
            <div>
              <h1 className="animate-fade-in-up text-5xl md:text-7xl text-primary">
                Mr. Miggles
              </h1>
            </div>

            {/* Subtitle */}
            <div className="animate-fade-in-up flex flex-row items-center justify-center">
              <h2 className="text-lg text-primary">The Feline Face Of</h2>
              <img
                src="https://framerusercontent.com/images/8ForajCgJPxB8yAtt825R6KwM.png?scale-down-to=512"
                alt=""
                className="h-5 translate-x-2"
              />
            </div>
            ...
            {/* Mobile Social Icons - Only on smaller screens */}
            <div className="md:hidden">
              <ul className="flex flex-row gap-2">
                {/* Social media icons */}
                <li className="h-9 w-9 flex items-center justify-center bg-Hero rounded-full hover:bg-[#0042CC]">
                  <a href="#"><img className="h-4 w-4" src="x.png" alt="X" /></a>
                </li>
                <li className="h-9 w-9 flex items-center justify-center bg-Hero rounded-full hover:bg-[#0042CC]">
                  <a href="#"><img className="h-4 w-4" src="telegram.svg" alt="Telegram" /></a>
                </li>
                <li className="h-9 w-9 flex items-center justify-center bg-Hero rounded-full hover:bg-[#0042CC]">
          ...
          <div className="flex overflow-hidden select-none gap-4 p-3">
            <ul className="animate-scroll flex shrink-0 justify-around min-w-full gap-4">
              {/* Repeated $MIGGLES text */}
              {[...Array(9)].map((_, index) => (
                <li key={index} className="text-2xl font-bold text-primary opacity-60">$MIGGLES</li>
              ))}
            </ul>
            <ul className="animate-scroll flex shrink-0 justify-around min-w-full gap-4" aria-hidden="true">
              {/* Duplicate marquee for continuous scrolling */}
              {[...Array(9)].map((_, index) => (
                <li key={index} className="text-2xl text-primary font-bold opacity-60">$MIGGLES</li>
              ))}
            </ul>
          </div>
          ...
          <video
            ...
            loop
            playsInline
            className="absolute inset-0 w-full h-full object-cover object-[70%] z-[-1]"
          />
        </div>
      </div>

      <div id="story" className=" my-20 items-center justify-center flex flex-col gap-3  md:flex-col-reverse">
        <div className="my-3 ">
      ...
      <div id="nft" className="flex gap-9 flex-col items-center justify-center  lg:flex-row my-20">
      ...
      <div id="merch" className="flex gap-9 flex-col-reverse  mx-5   items-center  md:justify-center  lg:flex-row my-20">
      ...
      <div id="partner" className="flex gap-9 flex-col items-center justify-center overflow-hidden  lg:flex-row my-20">
        {/* NFT Scrolling Container */}
      ...
      <div id="tokenomics" className="bg-Hero p-5 h-screen  flex flex-col gap-6 w-full items-center justify-center">
      ...
      <div id="faq" className="py-32 px-5">
        <Faq />
