  ...
  return (
    <div>
      ...
      <div className="flex gap-9 flex-col items-center justify-center  lg:flex-row my-20">
        ...
        <div className=" flex-1 pr-10 flex flex-col gap-4 mx-3 md:max-w-[810px] md:mx-20 lg:max-w-full">
          ...
          <div className="flex flex-row gap-3 my-3">
            <button className="group p-3 my-3 font-semibold text-lg bg-light-gradient text-primary rounded-lg flex items-center justify-between hover:gap-5 gap-2 transition-all duration-300">
              Buy $miggles
              <span className="">
